...
helm install hlf-kube --name hlf-kube -f samples/splunk-fabric/network.yaml -f samples/splunk-fabric/crypto-config.yaml -f samples/splunk-fabric/persistence.yaml --set peer.launchPods=false --set orderer.launchPods=false
