...
curl fabric-logger-peer0:8080/channels/buttercup-go
curl fabric-logger-peer0:8080/channels/haunt
curl fabric-logger-peer0:8080/channels/crisis-uprising
curl fabric-logger-peer0:8080/channels/containment-apocalyse
curl fabric-logger-peer0:8080/channels/rage-trilogy
curl fabric-logger-peer0:8080/channels/chaos-oath
